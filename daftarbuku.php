...
?>
<table class="tables" style="position:relative; left:100px; top:150px;">
	        <tr id="header" style="background-color:#084382;">
	            <th>Foto Buku</th>
	            <th>Buku</th>
	            <th style="width: 130px;">Kategori</th>
                <th> Penerbit</th>
	            <th class="www">Deskripsi Buku</th>
	            <th>Actions</th>
	        </tr>
	        ...
	        ?>
            <tr class="tc2">                
	            <td><img src="produk/<?php echo $hasil['foto_produk']; ?>" class="foto"</td>
	            <td class="buku"><?php echo $hasil['nama_produk'];?></td>
	            <td><?php echo $hasil['jenis_buku'];?></td>
                <td><?php echo $hasil['penerbit'];?></td>
	            <td><?php echo $hasil['deskripsi'];?></td>
	            <td>
 <button class="aa" style="background-color:#19A7CE; color:black; border:1px solid #f4f5f8; height:40px; width:80px; border-radius:4px;"><a href="editbuku.php?id_produk=<?php echo $hasil['id_produk']?>">Update</a>
<a href="deletebuku.php?id_produk=<?php echo $hasil['id_produk']?>" onclick="return confirm('yakin menghapus data');"></button>
