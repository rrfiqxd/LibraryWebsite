...
if(isset($_POST['submit'])){
   ...
   if(mysqli_num_rows($result)){
     ...
     header('location:adminpage.php');
      ...
      $error[] = 'Anda Belum Terdaftar Admin!';
   }
...
<head>
	...
	<title>LogAdmin SMARTONE - @rrfiqxd.php</title>
...
<body>
	...
	<div class="form-container">
      ...
      ?>
        ...
        <p style="text-align: center;">Belum Punya akun? <a href="registeradmin.php">Register</a></p>
    </form>
	</div>
